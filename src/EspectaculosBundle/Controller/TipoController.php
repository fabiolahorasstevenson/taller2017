...
class TipoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $tipos = $em->getRepository('EspectaculosBundle:Tipo')->findAll();
    ...
    {
        $tipo = new Tipo();
        $form = $this->createForm('EspectaculosBundle\Form\TipoType', $tipo);
    ...
    {
        $deleteForm = $this->createDeleteForm($tipo);
        $editForm = $this->createForm('EspectaculosBundle\Form\TipoType', $tipo);
